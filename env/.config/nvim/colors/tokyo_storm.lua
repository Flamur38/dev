-- fl4my_tokyo_storm.lua — fl4mys3c personal colorscheme
-- bg: #24283b  fg: #c0caf5  TokyoNight Storm
vim.cmd("highlight clear")
if vim.fn.exists("syntax_on") then vim.cmd("syntax reset") end
vim.g.colors_name = "fl4my_tokyo_storm"

-- ── Palette ───────────────────────────────────────────────────────────────────
local c = {
    bg          = "#24283b",   -- background
    bg_float    = "#1f2335",   -- popups / floats
    bg_ui       = "#1d2030",   -- statusline / tabline

    fg          = "#c0caf5",   -- foreground
    fg_dim      = "#565f89",   -- comments / line numbers
    fg_dark     = "#3b4261",   -- end of buffer / invisible

    comment     = "#565f89",   -- comments
    visual      = "#2e3356",   -- visual selection
